...
import { DashboardHomeComponent } from
    './dashboard/components/dashboardHome/dashboard-home.component';
...
import { InventoriesTableComponent }
    from './inventories/inventoriesTable/inventories-table.component';
...
import { JobTemplatesAddComponent }
    from './job-templates/job-templates-add/job-templates-add.component';
import { JobTemplateHomeComponent }
    from './job-templates/job-templates-home/job-template-home.component';
...
export const rootRouterConfig: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'credentials/add', component: CredentialsComponent,
                data: { addCredentials: true }
            }
        ],
        canActivate: [AuthGuard]
    },
